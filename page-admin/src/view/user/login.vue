    ...
    <div class="main-class">
        <div class="login-container">
            <div class="login-methods">
                <div :class="['method-item', activeTab === 'verify' && 'active']" @click="activeTabClick('verify')">
                    验证码登录
                </div>
                <div :class="['method-item', activeTab === 'password' && 'active']" @click="activeTabClick('password')">
                    密码登录
                </div>
                <div :class="['method-item', activeTab === 'qrcode' && 'active']" @click="activeTabClick('qrcode')">
                    二维码登录
                </div>
            </div>
            ...
            <div class="form-container">
                ...
                <div v-if="activeTab === 'password'" class="phone-input">
                    ...
                    <el-input v-model="username" placeholder="请输入用户名" type="text" class="name-input" />
                </div>

                <div v-if="activeTab === 'password'" class="phone-input">
                    <span style="width: 75px;">密码:</span>
                    <el-input v-model="pwd" placeholder="请输入密码" type="password" show-password />
                </div>
...
/* ::v-deep .name-input .el-input__wrapper { */
